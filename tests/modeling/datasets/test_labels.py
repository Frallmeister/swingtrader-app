...
def test_generate_v1_labels_rejects_unsorted_input() -> None:
...
def test_generate_v1_labels_preserves_index_and_does_not_mutate_input() -> None:
...
def test_generate_v1_labels_rejects_flat_identifier_columns() -> None:
